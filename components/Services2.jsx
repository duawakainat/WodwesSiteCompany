...
const PassValue = ({ title, author, title2 }) => {
  return (
    <div className="relative py-16 md:pt-28 md:pb-36">
      ...
      <div className="grid gap-10 lg:grid-cols-2 text-white w-[90%] mx-auto">
        <div>
          <h1 className="xl:text-[60px]  lg:text-[48px] md:text-[30px] text-[30px] font-bold xl:!leading-[60px] lg:!leading-[48px] leading-[30px]">
            <span className="text-[#f62c73] xl:text-[60px]  lg:text-[48px] md:text-[30px] text-[30px] font-bold xl:!leading-[60px] lg:!leading-[48px] leading-[30px]">
              {title2}
            </span>{" "}
            {title}
          </h1>
            ...
            <div className="[&>*:nth-child(1)]:mt-0 [&>*:nth-child(even)]:mt-5 [&>*:nth-child(3)]:mt-5">
              {Table.map((menu, index) => {
                return (
                  <div key={index} className="">
                    <input
                      className="w-full py-5 px-4 text-[rgba(26,26,26,0.40)] placeholder:text-[rgba(26,26,26,0.40)] bg-[#f9f9ff80] rounded-lg"
              ...
              <div className="w-full">
                <a className="bg-[#f62c73] gap-4 text-white border-2 border-[#f62c73] mt-5 font-[600] py-5 px-5 flex justify-center items-center">
                  ...
                  >
                    <path
                      d="M22.0005 11.1L4.10045 2.09999C3.20045 1.69999 2.20045 2.49999 2.60045 3.39999L5.10045 10.1L16.5004 12L5.10045 13.9L2.60045 20.6C2.30045 21.5 3.20045 22.3 4.10045 21.8L22.0005 12.8C22.7005 12.5 22.7005 11.5 22.0005 11.1Z"
                      fill="white"
                    ></path>
                  </svg>
                </a>
