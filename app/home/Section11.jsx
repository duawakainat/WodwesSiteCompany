          ...
          <div className="flex max-lg:flex-col gap-10 justify-between">
            <div className="lg:!w-[505px] lg:sticky lg:top-[8rem] w-full h-full">
              ...
              <p className="text-[18px] mt-5 font-[400] text-white leading-7">
                We are not a typical development agency — We are
                  ...
                  return (
                    <div key={index} className="">
                      <Image
                        ...
                        className="w-9 h-9"
                      />
                      <h3 className="lg:text-[28px] text-white font-[700] my-2">
                        {menu.h3Title}
                      </h3>
                      <p className="text-[16px] leading-[2.25rem] text-white">
                        {menu.para}
                      </p>
                    </div>
                  );
